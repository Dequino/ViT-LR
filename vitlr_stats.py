""" Simple ViT implementation in PyTorch with Latent Replay, evaluating performances on single batches"""
...
dataset = CORE50(root='/media/alberto/KINGSTON/core50', scenario="nicv2_391")
...
for i, train_batch in enumerate(dataset):
    ...
    if i == (preparation_loops + 5):
        delta = time() - starting_time
        print('Time for executing a new batch of 18 images: %0.2f s' % (delta / 5)) 
        exit()
